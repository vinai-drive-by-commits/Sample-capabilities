...
class Xcommerce_Cse_Block_ListProducts extends Mage_Core_Block_Template
{
	protected function _toHtml()
	{
		...
		curl_setopt($ch, CURLOPT_HTTPHEADER, array("Content-Type: avro/binary", "Authorization: Bearer QUkAAb+C7nO0IUEsnZicHpET77pyJRvdSErTtbrLH23JWCR36/3d5y+qJFU3Nu289k3Ymw==","X-XC-SCHEMA-VERSION: 1.0.0", "X-XC-SCHEMA-URI: http://localhost/fabric_post/contracts/cse.avpr")); // An array of HTTP header fields to set, in the format array('Content-type: text/plain', 'Content-length: 100')
